...
public class ConstructorUtil {
    ...
    public static boolean isDefaultConstructor(@NotNull PsiMethod method) {
        PsiClass containingClass = method.getContainingClass();
        if (!method.isConstructor() || containingClass == null)
            return false;
    ...
    public static boolean hasDefaultConstructor(@Nullable PsiClass psiClass) {
        if (psiClass == null)
            return false;
